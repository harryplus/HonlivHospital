 ...
 */
public class FifthMyHxtFragment extends BaseFragment<FifthMyHxtPresenter, FifthMyHxtModel> implements FifthContract.FifthMyHxtView {
...
//        switch (v.getId()) {
//            case R.id.addCard:
//                start(FifthMyHxtPwdFragment.newInstance());
//                break;
...
//            start(FifthMyHxtDetailFragment.newInstance());
//        } else {
//            start(FifthMyHxtPwdFragment.newInstance());
