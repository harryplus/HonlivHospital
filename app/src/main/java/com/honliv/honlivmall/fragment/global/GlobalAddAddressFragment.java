...
import com.honliv.honlivmall.model.fifth.child.GlobalAddAddressModel;
import com.honliv.honlivmall.presenter.fifth.child.GlobalAddAddressPresenter;
 ...
 */
public class GlobalAddAddressFragment extends BaseFragment<GlobalAddAddressPresenter, GlobalAddAddressModel> implements GlobalContract.GlobalAddAddressView, View.OnClickListener {
     ...
     * 以上三级联动
     *************/
    public static GlobalAddAddressFragment newInstance(Bundle args) {
        GlobalAddAddressFragment fragment = new GlobalAddAddressFragment();
